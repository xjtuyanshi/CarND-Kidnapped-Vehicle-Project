...
/**
 * Computes mutivariable gaussian ditribution weight.
 * @param (sig_x,sig_y) std of x and y coordinates of map landmark 
 * @param (x_obs,y_obs) observations in map coordinates for the landmark
 * @param (mu_x,mu_y) coordinates of the nearest landmarks
 */
